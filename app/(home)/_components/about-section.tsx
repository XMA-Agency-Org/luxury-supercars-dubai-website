...
import { ClipRevealOnScroll } from "@/components/ui/clip-reveal-on-scroll"
  ...
  return (
    <section className="py-16 md:py-20">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 lg:grid-cols-2 lg:gap-16">
        <StaggerChildren className="flex flex-col justify-center space-y-6" staggerDelay={0.12}>
          <StaggerItem>
            <SectionHeading>
        ...
        <ClipRevealOnScroll direction="left" className="relative min-h-[400px] lg:min-h-0">
          <Image
